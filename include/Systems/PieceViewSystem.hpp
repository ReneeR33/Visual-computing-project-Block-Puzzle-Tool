...
private:
    ...
    void updatePieceRotation(entt::entity singlePieceView, bool mouseOnSinglePieceView, double mouseXPos, double mouseYPos);
    void updateScrollViewScrollValue(double yoffset);
    void updateSinglePieceViewBackgroundColor(entt::entity singlePieceView, bool mouseOnSinglePieceView);
